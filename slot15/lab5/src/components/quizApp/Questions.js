...
const Questions = [
    ...
    {
      id: 8,
      question: 'Which of the following commands is used to create a new branch in Git?',
      options: ['git branch new_branch', 'git checkout new_branch', 'git commit -m "new_branch"', 'git merge new_branch'],
    ...
    },
    {
      ...
      options: ['git commit -m "message"', 'git stage', 'git add .', 'git update'],
      answer: 'git add .'
    },
  ]
